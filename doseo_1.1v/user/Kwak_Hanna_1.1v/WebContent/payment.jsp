...
<body>
	<div>
		<h3>결제 방식</h3>
		<a id="check_creditCard" type="button">신용카드</a>	
		<a id="check_real-timeBankTransfer" type="button">실시간 계좌이체</a>
		<a id="check_vbank" type="button">가상계좌</a>
		<a id="check_phone" type="button">휴대폰 소액결제</a>		
		<a id="check_kakaopay" type="button"><img src="payment_text_small.png"></a>
	</div>
	
<!-- 여기서부터는 결제방식에 따른 각각의 구현 코드 -->	
