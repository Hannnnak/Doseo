...
<div class="container">
	...
	<button class="btn btn-warning float-right" style="margin:10px;"><a href="write.do">후기 작성</a></button>
<table width="100%">
		<thead>
...
<div class="row justify-content-center">
	...
	<ul class="pagination">
		<li class="page-item"><c:if test="${reviewPage.startPage > 5}">
			<a href="list.do?pageNo=${reviewPage.startPage - 5}">[이전]</a></c:if></li>
		<li class="page-item"><c:forEach var="pNo" 
					   begin="${reviewPage.startPage}" 
					   end="${reviewPage.endPage}">
			<a href="list.do?pageNo=${pNo}">[${pNo}]</a>	</c:forEach></li>
		<li class="page-item"><c:if test="${reviewPage.endPage < reviewPage.totalPages}">
			<a href="list.do?pageNo=${reviewPage.startPage + 5}">[다음]</a>	</c:if></li>
	</ul>
	</c:if>
</div>
