...
<body>
<form name="modifyFrm" method="post" action="modify.dom" enctype="multipart/form-data">
...
<tr>
  ...
  <tr>
    <th>상품이미지</th>
    <td width="343" colspan="5">
    	<img src="/doseo/product_images/${modReq.imageFileURL}" >
      <input type="file" name="imageFileURL" value="${modReq.imageFileURL}">
    </td>
  </tr>    
</table>
<input type="submit" value="수정" >           
<input type="reset" value="취소" onclick="admin_product/list.dom">
</form> 
</body>
</html>