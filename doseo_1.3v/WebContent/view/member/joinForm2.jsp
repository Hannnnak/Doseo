...
<body>
	...
	<form name="joinFrm" id="joinFrm" onsubmit="return checks()"
		...
		<p>
			아이디 : <input type="text" name="id" id="id" value="${param.id}" placeholder="4~12자의 영문 대소문자와 숫자로만 입력" maxlength="12"  />
      ...
      <input type="radio" name="gender" value="남자" checked />남자
		...
		<p>
			생 일 : 
			 ...
			 <input type="text" name="birthyy" id="birthyy" maxlength="4" value="" placeholder="년(4자)" size="6" >년
