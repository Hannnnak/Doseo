...
<div>
	<c:if test="${AUTHUSER.id == reviewData.review.writer.id}">
		<button class="btn btn-warning float-left" style="margin:10px;"><a href="list.dom">목록</a></button>
		<button class="btn btn-warning float-right" style="margin:10px;"><a href="delete.dom?no=${reviewData.review.number}">후기 삭제</a></button>
		<button class="btn btn-warning float-right" style="margin:10px;"><a href="modify.dom?no=${reviewData.review.number}">후기 수정</a></button>
	</c:if>
<!--	
	<c:if test="#">
		<button class="btn btn-warning float-left" style="margin:10px;"><a href="list.do">목록</a></button>
		<button class="btn btn-warning float-right" style="margin:10px;"><a href="delete.do?no=${reviewData.review.number}">후기 삭제</a></button>
	</c:if>
-->	
</div>
