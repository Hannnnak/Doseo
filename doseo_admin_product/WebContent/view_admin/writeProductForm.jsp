...
<h1>상품등록</h1>
<br/>
<h2>http://localhost/doseo/admin_product/write.dom</h2>
<br/>
<form name="productFrm" method="post" action="write.dom">
<table id="list">
<tr>
  <th>장르(분야)</th>
...
<tr>
  ...
  <td width="343" colspan="5">
       <input type="text" name="pName" size="47" maxlength="100" value="도서명을 입력하세요">
  </td>
</tr>
<tr>
	<th>작가</th>
...
<tr>
  ...
  <tr>
    <th>상세설명</th>
    <td colspan="5">
      <textarea name="detailContent" rows="8" cols="70" >제품 설명을 적어주세요.</textarea>
    </td>
  </tr>
  <tr>
    <th>상품이미지</th>
