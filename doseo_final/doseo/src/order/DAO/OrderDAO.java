...
public class OrderDAO {
	...
	public void insertOrderDetail(Cart cart, int maxoNo) {
		...
		try {
			conn = ConnectionProvider.getConnection();
			String insertOrderDetail = "insert into Odetail(oNo, dpNo, pNO, dPrice, quantity, total) values(?, dpNo.nextval, ?, ?, ?, ?)";
	...
	public List<Order> selectById2(Connection conn, String memberId) throws SQLException {
