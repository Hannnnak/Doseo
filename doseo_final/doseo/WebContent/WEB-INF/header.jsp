...
<%	String userID = null; %>
	...
	<div class="top-menu">
		<div class="topbtn1">
			...
			<input type="button" class="btn btn-outline-secondary" value="후기" onclick="location.href='review/list.dom'">
			<input type="button" class="btn btn-outline-secondary" value="Q&A" onclick="location.href='qnalist.dom'">
		</div>
		<div class="headerImg">
			<a href="view_member/main.jsp" class="link_main"><img src="logo_transparent.png" height=300px width=300px/></a>
		</div>
		<div class="topbtn2">
		...
		<div class="topbtn2">
         <input type="button" class="btn btn-outline-secondary" value="로그아웃" onclick="location.href='logout.dom'">
         <input type="button" class="btn btn-outline-secondary" value="관리자페이지" onclick="location.href=''">
         <input type="button" class="btn btn-outline-secondary" value="관리자리스트(TEST)" onclick="location.href='listad.dom'">
		</div>
	</div>
