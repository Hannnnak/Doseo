	...
	<c:if test="${productPage.hasProducts() }">
		<tr>
			<th colspan="5">
				...
				<li class="page-item"><a href="main.dom?pageNo=${productPage.startPage-5}" class="page-link">이전</a></li>
				</c:if>
				...
				<li class="page-item"><a href="main.dom?pageNo=${pNum}" class="page-link">${pNum}</a></li>
				</c:forEach>
				
				<%-- [다음next]출력 --%>
				<c:if test="${productPage.endPage<productPage.totalPages}">
				<li class="page-item"><a href="main.dom?pageNo=${productPage.startPage+5}" class="page-link">다음</a></li>
				</c:if>
			</th>
		</tr>
	</c:if>
